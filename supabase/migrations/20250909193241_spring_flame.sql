/*
  ...
  This migration removes any references to the photographers table from the contratos table
  since we no longer use the photographers table in the application.
